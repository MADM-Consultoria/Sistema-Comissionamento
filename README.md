...
select id,lead_usuario_responsavel, funil_vendas, etapa_lead, resp_analise_segurado, 
       data_analise_segurado ,status_contrato, data_assinatura,data_ganho
  from madm.kommo_leads
    WHERE
	
/* ----- Consulta de usuários ----- */
select internal_id, id_kommo, colaborador, e_mail, senha_app_comissionamento, equipe, grupo , status, periodo
  from madm.colaboradores
    WHERE 
	  e_mail = '' and
      periodo = '2026-0' and
...
/* ----- Consulta de emitidos ----- */
select id,lead_usuario_responsavel, funil_vendas, etapa_lead,status_contrato, data_assinatura
  from madm.kommo_leads
    WHERE
	   lead_usuario_responsavel = 'Gabriela de Oliveira Giorni' and
	   status_contrato = 'Emitidos' and
	   data_assinatura = '2026-04-21'
	   
/* ----- Consulta de Assinados ----- */
select id,lead_usuario_responsavel, funil_vendas, etapa_lead,status_contrato, data_assinatura
  from madm.kommo_leads
    WHERE
	   lead_usuario_responsavel = 'Gabriela de Oliveira Giorni' and
	   status_contrato = 'Assinado' and
	   data_assinatura = '2026-04-21'
